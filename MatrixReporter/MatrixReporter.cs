...
namespace MatrixReporter
{
    /// <summary>
    /// Encapsules basic formatting codes, for Epson printers,
    /// like Bold, Italic, Condensed
    /// </summary>
    public class EpsonCodes : MatrixReporter.SpecialCodes.IFormatting
    {
        ...
        public EpsonCodes()
        {
            ByteCodes = new Byte[] { 15, 18, 27, 45, 48, 50, 52, 53, 64, 67, 69, 70, 77, 80, 87, 12, 75 };
            ...
            _75 = ASCIIEncoding.ASCII.GetString(ByteCodes, 16, 1);
        }
        ...
        public string DuplaAlturaOn
        {
            get { return _27 + _75 + "0" + "128" + "255" + "0"; }
        }
    ...
    public class Reporter
    {
        ...
        {
            TextReader reader = File.OpenText(FTempFile);
            string texto = "";
        ...
        public void PrintJob()
        {
            try
            {
                ...
                for (int i = 1; i <= FCopies; i++)
                {
                    ...
                    //process1.StartInfo.Arguments = " /b FTempFile FOutput";
                    //process1.Start();  
                }
            }
            catch(Exception ex)
        ...
        public override string ToString()
        {
            ...
            //     s.Append(FRow);
            //      s.Append(FCopies);
            s.Append(InternalText);
            //     s.Append(FActive);
            //    s.Append(Arquivo);
            //      s.Append(CarriageReturn);
            //   s.Append(ByteCodes);
            //  s.Append(_126);
            //   s.Append(_8);
            //   s.Append(_96);
