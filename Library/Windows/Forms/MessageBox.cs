...
namespace Library.Windows.Forms
{
    ...
    public partial class MessageBox : Form
    {
        ...
        static public DialogResult Show(string title, string largeHeading, string smallExplanation,
            string leftButton, string rightButton, Image iconSet)
        {
            using (MessageBox dialog = new MessageBox(title, largeHeading, smallExplanation, leftButton,
                rightButton, iconSet))
            {
        ...
        /// </summary>
        private MessageBox(string title, string largeHeading, string smallExplanation,
            string leftButton, string rightButton, Image iconSet)
        {
