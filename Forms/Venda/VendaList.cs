...
namespace Forms.Venda
{
    public partial class VendaList : Form
    {
        ...
        private void resultadoDGV_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Library.Venda venda = Library.VendaBD.FindById((long)rowSelected.Cells[0].Value);
        ...
        private void DeleteRow(int index)
        {
            try
            {
                ...
                {
                    Library.VendaBD.Delete(Library.VendaBD.FindById((long)this.resultadoDGV.Rows[index].Cells[0].Value));
        ...
        private void PrintRow(int index)
        {
            try
            {
              /*  Reports.nota_venda notav = new Reports.nota_venda();
                ...
                Library.Classes.Print.PrintVenda(Library.VendaBD.FindById((long)this.resultadoDGV.Rows[index].Cells[0].Value));
            }
            catch (Exception ex)
            {
                Library.Diagnostics.Logger.Error(ex);
        ...
        private void VendaList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Escape:
        ...
        private void resultadoDGV_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
