...
namespace Forms.Setor
{
    public partial class Setor : Form
    {
        ...
        private void editarButton_Click(object sender, EventArgs e) 
        {
            ...
            this.setor = Library.SetorBD.FindById(idSetor);
        ...
        private void excluirButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                setor = Library.SetorBD.FindById((long)this.dataGridView1.SelectedRows[i].Cells["idDGVTBC"].Value);
            }
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                long idSetor = (long)this.dataGridView1.SelectedRows[0].Cells["idDGVTBC"].Value;
        ...
        private void Setor_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F2:
        ...
        private void Setor_FormClosing(object sender, FormClosingEventArgs e)
        {
            switch (this.Modo)
            {
                case "Cadastrar":
